...
float nmc_simplex3D(float3 v)
{
    ...
    // Apply seed offset to input. All backends now use 0.1271: the WGSL this
    // was first ported from used 0.0001 (diverged for nonzero seed) until
    // upstream bade9acc adopted the GLSL reference constant — no change here.
